...
public abstract class ConstructorsAbstractIntegrarB1LoadData implements IntegrarB1LoadDataService  {
	...
	public RestClientB1Json<GuidB1ModelInput, GuidB1Model, VerifyB1ModelInput, VerifyB1Model> restClient;
	
	public RestClientB1Api<JsonCategoryInput> restClientApi;
	...
	public GravarDadosB1Service<List<JsonCategoryInnerInput>> gravarDadosCategoryService;
}
