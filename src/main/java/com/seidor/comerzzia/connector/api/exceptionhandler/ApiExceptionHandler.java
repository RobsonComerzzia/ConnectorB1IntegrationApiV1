...
import com.seidor.comerzzia.connector.exception.EntityInUseException;
import com.seidor.comerzzia.connector.exception.EntityNotFoundException;

import jakarta.validation.UnexpectedTypeException;
import com.seidor.comerzzia.connector.exception.BussinessRoleException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleTipoInesperado(UnexpectedTypeException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleNegocio(InvalidDataAccessResourceUsageException ex, WebRequest request) {
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage("Erro ao recuperar dados do banco de dados")
				.build();
